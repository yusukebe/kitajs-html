...
/**
 * Returns a promise that resolves to the entire HTML generated by the
 * component tree. **Suspense calls are waited for**.
 *
 * This method is a shorthand to call {@linkcode renderToStream} and collect
 * its result into a string.
 *
 * **Rendering to string will not give any benefits over streaming, it will
 * only be slower.**
 *
 * @param factory The component tree to render.
 * @param rid The resource id to identify the request, if not provided, a new
